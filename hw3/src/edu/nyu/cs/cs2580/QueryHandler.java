...
class QueryHandler implements HttpHandler {
	...
	public void handle(HttpExchange exchange) throws IOException {
		...
		if(uriPath.equals("/search") ){
			...
			QueryRepresentation  query_represenation = new QueryRepresentation(processedQuery, ranker, cgiArgs._numDocs, cgiArgs._numTerms,
					_indexer);
			Map<String, Double> result = query_represenation.computeRepresentation();
			StringBuffer response = new StringBuffer();
